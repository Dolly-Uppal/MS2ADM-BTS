...
class PretrainDataset(Dataset):
    ...
    def read_data(self, data_path):
        ...
        image_paths = [
            os.path.join(data_path, f"BraTS19_Training_{file_identifizer}_flair.nii.gz"),
            os.path.join(data_path, f"BraTS19_Training_{file_identifizer}_t1.nii.gz"),
            os.path.join(data_path, f"BraTS19_Training_{file_identifizer}_t1ce.nii.gz"),
            os.path.join(data_path, f"BraTS19_Training_{file_identifizer}_t2.nii.gz")
        ]
        seg_path = os.path.join(data_path, f"BraTS19_Training_{file_identifizer}_seg.nii.gz")
        ...
        if self.cache:
            ...
            try:
                ...
                with open("./bugs.txt", "a+") as f:
                    f.write(f"dataa，{self.datalist[i]}\n")
